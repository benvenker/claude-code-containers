...
1. Make sure you are on the dev-demos branch before you start (unless instructed to start on a specific branch)
2. Understand the code that is there before you begin to change it.
3. Read the feauture requirements in @Plan.md
4. Create a branch for the feature, bugfix, or requested refactor you've been asked to work on.
5. Employ test-driven development. Red-Green-Refactor process (outlined below)
6. When committing to git, omit the Claude footer from comments.
7. Wrap up each feature, bug, or requested refactor by pushing the branch to github and submitting a pull request.
8. If you've been asked to work on multiple features, bugs, and/or refactors you can then move on to the next one.
